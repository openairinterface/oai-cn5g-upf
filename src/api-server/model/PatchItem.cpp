...
org::openapitools::server::model::PatchOperation PatchItem::getOp() const
{
    return m_Op;
}
void PatchItem::setOp(org::openapitools::server::model::PatchOperation const& value)
{
    m_Op = value;
}
...
org::openapitools::server::model::nlohmann::json PatchItem::getValue() const
{
    return m_Value;
}
void PatchItem::setValue(org::openapitools::server::model::nlohmann::json const& value)
{
    m_Value = value;
    m_ValueIsSet = true;
}
