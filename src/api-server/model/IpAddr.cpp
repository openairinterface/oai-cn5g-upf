...
org::openapitools::server::model::Ipv6Addr IpAddr::getIpv6Addr() const
{
    return m_Ipv6Addr;
}
void IpAddr::setIpv6Addr(org::openapitools::server::model::Ipv6Addr const& value)
{
    m_Ipv6Addr = value;
...
org::openapitools::server::model::Ipv6Prefix IpAddr::getIpv6Prefix() const
{
    return m_Ipv6Prefix;
}
void IpAddr::setIpv6Prefix(org::openapitools::server::model::Ipv6Prefix const& value)
{
    m_Ipv6Prefix = value;
