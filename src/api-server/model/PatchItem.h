...
public:
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::PatchOperation getOp() const;
    void setOp(org::openapitools::server::model::PatchOperation const& value);
    /// <summary>
    ...
    /// 
    /// </summary>
    org::openapitools::server::model::nlohmann::json getValue() const;
    void setValue(org::openapitools::server::model::nlohmann::json const& value);
...
protected:
    org::openapitools::server::model::PatchOperation m_Op;

    std::string m_Path;

    std::string m_From;
    bool m_FromIsSet;
    org::openapitools::server::model::nlohmann::json m_Value;
    bool m_ValueIsSet;
