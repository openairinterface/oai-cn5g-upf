 ...
 *              Updated includes: removed pfcp_far/pfcp_pdr, upf_xdp_maps.h,
 *              interfaces.h (bar_apply is terminal — no session/interface maps
 *              used directly); xdp_stats_kern.h -> stats_maps.h,
 *              xdp_stats_kern_user.h -> stats_types.h.
 */
// clang-format on
