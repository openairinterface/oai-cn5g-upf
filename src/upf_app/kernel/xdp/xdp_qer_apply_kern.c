 ...
 *              Updated includes: removed pfcp_far/pfcp_pdr (transitive via
 *              pipeline_maps.h); upf_xdp_maps.h -> pipeline_maps.h;
 *              interfaces.h -> interfaces_maps.h; sdf_filter.h -> sdf_types.h;
