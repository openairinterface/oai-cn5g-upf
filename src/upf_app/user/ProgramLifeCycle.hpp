 ...
 *                - Added `name_` field to ProgramLifeCycle constructor so every
 *                  log line identifies which BPF program is being operated on.
 *                  Before: "BPF skeleton opened successfully"
 *                  After:  "[N3EntryProgram] BPF skeleton opened successfully"
 * 3GPP Refs:   n/a
 */
// clang-format on
