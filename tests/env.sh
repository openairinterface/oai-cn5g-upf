...
DUT_UPF_WORKSPACE_STANDALONE="${WORKSPACE}"/oai-cn5g-upf
DUT_CN_WORKSPACE_STANDALONE="${WORKSPACE}"/oai-cn5g-fed
CN_DOCKER_COMPOSE_FILE=docker-compose-trex.yaml

UPF_N3_INTERFACE=enp5s0f0
UPF_N6_INTERFACE=enp5s0f1
...
JUMP_SERVER_USERNAME="ubuntu"
JUMP_SERVER_IP="172.21.16.88"
JUMP_SERVER_PORT=

# Trex server configuration.
TREX_SERVER_NAME="trex"
TREX_SERVER_IP="172.21.16.88"
TREX_SERVER_ASYNC_PORT="4501"
TREX_SERVER_SYNC_PORT="4500"
TREX_SERVER_USERNAME="ubuntu"
...
TREX_SERVER_DOWNLOAD_DIR="${WORKSPACE}"
